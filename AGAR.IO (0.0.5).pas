...
begin
  ...
  begin
    Agar[i].X += Agar[i].dX;
    Agar[i].Y += Agar[i].dY;
    Agar[i].ddX += Random(-8,8) / 64;
    if ABS(Agar[i].ddX) > 0.3 then Agar[i].ddX := 0;
    Agar[i].ddY += Random(-8,8) / 64;
    if ABS(Agar[i].ddY) > 0.3 then Agar[i].ddY := 0;
    Agar[i].dX += Agar[i].ddX;
    if ABS(Agar[i].dX) + ABS(Agar[i].dY) > 4 then
    begin
      Agar[i].dX -= Agar[i].ddX;
      Agar[i].ddX := 0;
    end;
    Agar[i].dY += Agar[i].ddY;
    if ABS(Agar[i].dX) + ABS(Agar[i].dY) > 4 then
    begin
      Agar[i].dY -= Agar[i].ddY;
      Agar[i].ddY := 0;
